...
;
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($request->has('image')) {
            $imageName = Helpers::upload('notification/', APPLICATION_IMAGE_FORMAT, $request->file('image'));
        } else {
            $imageName = null;
        }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        if ($request->has('image')) {
            $imageName = Helpers::update('notification/', $notification->image, APPLICATION_IMAGE_FORMAT, $request->file('image'));
        } else {
