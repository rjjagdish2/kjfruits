...
class ConversationController extends Controller
{
    ...
    public function storeMessageByOrder(Request $request, $sender_type): JsonResponse
    {
        ...
        if($sender_type == 'deliveryman') {
            ...
            $profileImage = $deliveryman?->image;
        }
        ...
        try {
            Helpers::send_push_notif_to_device(fcm_token: $receiver_fcm_token, data: $data, senderType: $sender_type, name: $name, profile_image: $profileImage);
        } catch (\Exception $exception) {
