...
class CategoryLogic
{
    ...
    public static function products($category_id,$limit,$offset)
    {
        ...
        $paginator = Product::active()->withCount(['wishlist', 'active_reviews'])->with('rating')->whereIn('id', $productIds)->paginate($limit, ['*'], 'page', $offset);
        return [
