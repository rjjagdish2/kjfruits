...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{env('APP_MODE')=='demo'? "javascript:" : route('admin.settings')}}" method="post" enctype="multipart/form-data" id="admin-settings-form">
                @csrf
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form id="changePasswordForm" action="{{env('APP_MODE') =='demo'? "javascript:" : route('admin.settings-password')}}" method="post"
