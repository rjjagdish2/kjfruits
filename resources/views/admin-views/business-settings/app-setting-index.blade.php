            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{env('APP_MODE')=='demo'?'javascript:' : route('admin.business-settings.web-app.system-setup.app_setting',['platform' => 'android'])}}"
                            method="post">
                            @csrf
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{env('APP_MODE')=='demo'?'javascript:' : route('admin.business-settings.web-app.system-setup.app_setting',['platform' => 'ios'])}}"
                            method="post">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between mb-2">
