...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{env('APP_MODE')=='demo'?"javascript:" : route('admin.business-settings.web-app.third-party.map-api-store')}}" method="post">
                    @csrf
                    <div class="row">
                    ...
                    <div class="btn--container justify-content-end">
                        ...
                        <button type="{{env('APP_MODE')=='demo'?'button':'submit'}}" class="btn btn-primary call-demo">{{translate('save')}}</button>
                    </div>
                </form>
            </div>
        </div>
