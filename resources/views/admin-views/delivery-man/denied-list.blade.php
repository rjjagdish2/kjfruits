                        ...
                        @foreach ($deliverymen as $key => $deliveryman)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <label
                                            class="badge badge-soft-primary">{{ $deliveryman->branch ? $deliveryman->branch->name : 'Branch deleted!' }}</label>
                                    @endif
                                </td>
                                        ...
                                        @foreach ($deliveryman->identityImageFullPath as $identification_image)
                                            <div class="mx-h80 overflow-hidden">
                                                <img class="cursor-pointer rounded img-fit p-2 w-100px mh-80px show-image-modal"
                                                    src="{{ $identification_image }}" data-image="{{ $identification_image }}"
                                ...
                                <td class="text-center">
                                    <strong
                                        class="text-danger text-capitalize">{{ translate($deliveryman->application_status) }}</strong>
                                </td>
                                <td class="text-center">
                    ...
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div data-dismiss="modal">
                                <img src="" alt="{{ translate('image') }}" class="w-100" id="identification_image_element">
                            </div>
                        </div>
                    </div>
                </div>
