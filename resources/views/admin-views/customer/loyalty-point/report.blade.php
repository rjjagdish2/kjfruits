        ...
        <div class="page-header">
            <h1 class="page-header-title text-capitalize">
                <div class="card-header-icon d-inline-flex mr-2 img">
                    <img src="{{ asset('/public/assets/admin/img/point.png') }}" alt="{{ translate('loyalty_point') }}"
                        class="width-24">
                </div>
                <span>
        ...
        <div class="card mt-4">
            <div class="card--header order-top">
                <div class="d-flex gap-2 align-items-center">
                    <h5 class="mb-0"> <span class="card-header-icon"><i class="tio-money"></i></span>
                    ...
                    <tbody>
                        @foreach ($transactions as $k => $loyaltyTransaction)
                            <tr scope="row">
                                ...
                                <td>
                                    <a
                                        href="{{ route('admin.customer.view', ['user_id' => $loyaltyTransaction->user_id]) }}">
                                ...
                                <td>
                                    <span
                                        class="badge badge-soft-{{ $loyaltyTransaction->transaction_type == 'point_to_wallet' ? 'success' : 'dark' }}">
                                        {{ translate($loyaltyTransaction->transaction_type) }}
                                    </span>
                                </td>
                                <td>{{ date('Y/m/d ' . config('timeformat'), strtotime($loyaltyTransaction->created_at)) }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
