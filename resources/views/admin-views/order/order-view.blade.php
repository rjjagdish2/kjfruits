                ...
                <div class="card-header flex-wrap align-items-start border-0">
                    ...
                    <div class="w-100">
                        ...
                        @if ($order['bring_change_amount'])
                            <h5><strong>{{ translate('Bring Change Note') }}</strong>: <span
                                    class="badge-soft-success">{{ translate('Please ensure the Deliveryman has ') . Helpers::set_symbol($order['bring_change_amount']) . translate(' in change ready for the customer') }}</span>
                            </h5>
                        @endif
                    </div>
                </div>
                                    ...
                                    <div class="media media--sm">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h5 class="mt-1"><span
                                                ...
                                                : {{ $detail['price'] }} </h5>
                                            <h5 class="mt-1"><span class="text-body">{{ translate('QTY') }}</span> :
                                                {{ $detail['quantity'] }}
                                            </h5>
                                        </div>
                                    </div>
